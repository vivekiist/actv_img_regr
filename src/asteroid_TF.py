...
def asteroid_volume(phi_values, theta_values):
	...
	###################################################################
	all_params = []
	# Properties modified on asteroid_28649vti
	...
	for i in range(len(phi_values)):
		...
		outfile = '../data/asteroid_volume_images/test/' \
...
## write the csv file with phi and theta values
	...
	np.savetxt('../data/asteroid_volume_images/test/asteroid_viewparams_test.csv', \
