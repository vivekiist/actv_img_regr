...
def isabel_velocity_volume(phi_values, theta_values):
	...
	velocityf15binLEraw_corrected_2_subsampledvti = XMLImageDataReader(registrationName='Velocityf15.binLE.raw_corrected_2_subsampled.vti', FileName=['../data/Isabel_velocity_raw/Velocityf25.binLE.raw_corrected_2_subsampled.vti'])
