...
# # ax_loss.plot(epochs, test_ssim_mse[100:], label="Test SSIM MSE")
# ax_loss.plot(epochs, test_ssim_rmse[100:], label="Test SSIM RMSE")
# # ax_loss.plot(epochs, test_ssim_vgg[100:], label="Test SSIM VGG")
# ax_loss.plot(epochs, test_ssim_rvgg[100:], label="Test SSIM Random VGG")
# # ax_loss.plot(epochs, test_ssim_comp[100:], label="Test SSIM Complexity")
# # ax_loss.plot(epochs, test_ssim_rcomp[100:], label="Test SSIM Random Complexity")
# ax_loss.plot(epochs, rtest_ssim[100:], label="Test SSIM Random")
...
# ax_loss = f_loss.add_subplot(111)
# # ax_loss.plot(epochs, test_ssim_mse[100:], label="Test SSIM MSE")
# ax_loss.plot(epochs, test_losses_rmse[100:], label="Test loss Random + MSE")
# # ax_loss.plot(epochs, test_ssim_vgg[100:], label="Test SSIM VGG")
# # ax_loss.plot(epochs, test_ssim_rvgg[100:], label="Test SSIM Random + VGG")
# # ax_loss.plot(epochs, test_ssim_comp[100:], label="Test SSIM Complexity")
# # ax_loss.plot(epochs, test_ssim_rcomp[100:], label="Test SSIM Random + Complexity")
# ax_loss.plot(epochs, rtest_losses[100:], label="Test loss Random")
...
# ax_loss.plot(epochs, test_ssim_comp[100:], label="Test SSIM Complexity")
# ax_loss.plot(epochs, test_ssim_rcomp[100:], label="Test SSIM Random + Complexity")
ax_loss.plot(epochs, rtest_lpips[100:], label="Test LPIPS for Random")
